  ...
  const categories = [
    {
      ...
      name: "Academic",
      description:
        "Pursuit of knowledge through education, research, and scholarly activities in diverse disciplines, fostering intellectual growth and critical thinking.",
      icon: (
        <svg
...

    {
      ...
      name: "Professional",
      description:
        "Skilled, competent, experienced, ethical, specialized, reliable, responsible, proficient, dedicated, knowledgeable, disciplined, effective, committed, punctual, respectful, courteous, proactive, adaptable, trustworthy, and results-driven.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
...

    {
      ...
      name: "Job Related",
      description:
        "Seek roles aligned with skills & passion, networking, tailor resume, prepare for interviews, continuous learning, professionalism, and adaptability.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
      ...
      <section className="md:h-[calc(100vh-136px)] flex justify-center items-center bg-primary/10 py-12">
        <div className="flex flex-wrap justify-center items-center gap-4 px-4">
          {categories.map((category) => (
            <div
              key={category.id}
              class="max-w-sm p-6 bg-white rounded-lg border border-secondary"
            >
              {category.icon}
