/**
 * Title: Write a program using JavaScript on Academic Mentors
...
const AcademicMentors = () => {
  const { academic } = useSelector((state) => state.mentor.mentors);
...
export default AcademicMentors;
